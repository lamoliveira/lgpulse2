export const Head = (props) => {
  ...
  return (
    <>
      ...
      <link rel="icon" href={imgHost + "/img/superlogica/superlogica.png?h=32&w=32"} type="image/ico" />
      <link rel="icon" href={imgHost + "/img.superlogica/superlogicalogo.png?h=32&w=32"} type="image/png" />
      <link
        rel="icon"
      ...
      <link
        rel="icon"
        href={imgHost + "/img/superlogica/superlogicalogo.png?h=32&w=32"}
        type="image/png"
        media="(prefers-color-scheme: dark)"
      />
    </>
