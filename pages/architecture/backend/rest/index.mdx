...
The typical workflow for building and publishing content is to do it manually with LG Desktop. You might need to publish with the REST API for a variety of reasons. For example:
